...
function helper(id, username, name, lname, address) {
		...
		if (status === 'OK') {
			...
			marker.addListener('click', function() {
				...
				var infowindow = new google.maps.InfoWindow({
					content : '<img src="resources/images/'+ username +'.png" />' 
							+ '<h1>' + name + ' ' + lname + '</h1>' + '<h3>'
							+ address + '</h3>'
